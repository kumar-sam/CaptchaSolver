...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->linkLabel1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
			this->linkLabel1->LinkColor = System::Drawing::Color::Red;
			this->linkLabel1->Location = System::Drawing::Point(300, 364);
			this->linkLabel1->Name = L"linkLabel1";
			this->linkLabel1->Size = System::Drawing::Size(83, 25);
			this->linkLabel1->TabIndex = 9;
			this->linkLabel1->TabStop = true;
			this->linkLabel1->Text = L"Training";
...
private: System::Void linkLabel1_LinkClicked(System::Object^  sender, System::Windows::Forms::LinkLabelLinkClickedEventArgs^  e) {
			 this->Hide();
			 training^ f4 = gcnew training(this);
			 //train_controller();
			 f4->ShowDialog();
