...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(88, 245);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(281, 29);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Welcome to Home Page ";
			this->label1->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			this->label1->Click += gcnew System::EventHandler(this, &success::label1_Click);
			// 
			// button1
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &success::button2_Click);
			// 
			// success
			// 
			...
			this->ClientSize = System::Drawing::Size(442, 606);
			...
			this->Name = L"success";
			this->Text = L"success";
			this->Load += gcnew System::EventHandler(this, &success::success_Load);
...
#pragma endregion
	...
	private: System::Void success_Load(System::Object^  sender, System::EventArgs^  e) {
			 }
